...
@app.on_edited_message(filters.command(["eval", "x"])& filters.user(OWNER_ID) & ~filters.forwarded & ~filters.via_bot)
@app.on_message( filters.command(["eval", "x"]) & filters.user(OWNER_ID) & ~filters.forwarded & ~filters.via_bot)
